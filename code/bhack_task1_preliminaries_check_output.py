...
fname=out_dir+'bhack_task_01_output.mat'
tmp=io.loadmat(fname)
matlab_results = tmp['Xs'][0]
mat_xs=matlab_results
matlab_results=[x.shape for x in matlab_results]
...
#Shapes comparison :
print(python_results[0] == matlab_results[0]) #consistent
print(python_results[1] == matlab_results[1]) #consistent
print(python_results[2] == matlab_results[2]) #not consistent; python_results got 1 dim less

#elements comparison :
resdiff0=mat_xs[0]-python_xs[0]
print(np.mean(resdiff0))   #Out[47]: -0.28703903375392187
resdiff1=mat_xs[1]-python_xs[1]
print(np.mean(resdiff1))   #Out[49]: -2.249443e-07
resdiff2=mat_xs[2][0:1468,:,:]-python_xs[2]
print(np.mean(resdiff2))    #Out[53]: -3.1915752271876876e-08
